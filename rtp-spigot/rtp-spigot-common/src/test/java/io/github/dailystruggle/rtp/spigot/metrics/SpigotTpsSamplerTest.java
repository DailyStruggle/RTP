...
class SpigotTpsSamplerTest {

    private static SpigotTpsSampler samplerWithClock(AtomicLong clock) {
        return new SpigotTpsSampler(clock::get);
    }

    @Test
    void before_any_tick_all_getters_return_unsampled_sentinels() {
        AtomicLong clock = new AtomicLong(0L);
        SpigotTpsSampler s = samplerWithClock(clock);
