...
the RTP project and its community a harassment-free experience for everyone,
...
- Entitled or demanding behavior toward maintainers, including repeated
  pinging, cross-posting the same request in multiple channels, or
  demanding free support as a right.
- Requests for support of cracked, pirated, or otherwise unlicensed server
  software.
...
This Code of Conduct applies within all community spaces operated by or on
behalf of the RTP project, including:

- The GitHub repository (issues, pull requests, discussions, commits,
  code review).
- The SpigotMC resource page and its discussion thread.
- Any community chat channels (Discord, IRC, etc.) linked from the repo.
- Public spaces when an individual is officially representing the project.

Representation includes using an official project email address, posting
...
[private security advisory](https://github.com/DailyStruggle/RTP/security/advisories/new)
with `[CoC]` in the title, or by direct message via the contact method
