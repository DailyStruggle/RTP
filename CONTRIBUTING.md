...
If you use an agentic AI coding assistant, point it at [`.junie/AGENTS.md`](.junie/AGENTS.md) at session start — it consolidates the pre-flight checklist, S-00x safety rules, architecture boundaries, and environment setup. Optional, not a contribution requirement. Human contributors do not need to read it; equivalent guidance lives in this file and under `docs/dev/`.
