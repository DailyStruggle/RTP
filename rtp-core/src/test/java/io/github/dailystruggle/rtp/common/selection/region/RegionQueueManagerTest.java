...
public class RegionQueueManagerTest {
    ...
    void testPriorityPolling() {
        ...
        try {
            Assertions.assertEquals(fastLoc, poll1.get().getCoords());
        } catch (Exception e) {
            Assertions.fail(e);
        }
        ...
        try {
            Assertions.assertEquals(playerLoc, poll2.get().getCoords());
        } catch (Exception e) {
            Assertions.fail(e);
        }
        ...
        try {
            Assertions.assertEquals(globalLoc, poll3.get().getCoords());
        } catch (Exception e) {
            Assertions.fail(e);
        }
