 ...
 *
 * <p>Produces a canvas-sized palette buffer by leap-sampling {@link MemoryShape}
 * bounds and classifying in-memory bad locations (REQ-RTP-MAP-006, REQ-RTP-S-005).</p>
 */
public final class RegionBadLocationsShapeResolver implements ChartSpecResolver {
    ...
    /**
     * Maps a {@link LocationGenerator.FailTypes} ordinal to a logical {@link PaletteIndex} byte.
     *
