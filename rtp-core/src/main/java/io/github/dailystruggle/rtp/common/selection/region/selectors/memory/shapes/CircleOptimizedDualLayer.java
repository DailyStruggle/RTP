...
/**
 * Circle shape implementing the continuous spiral-addressed Hilbert key space with
...
public class CircleOptimizedDualLayer extends Circle {
  ...
  private final Circle macroCircle;
  ...
  public CircleOptimizedDualLayer(String name, int pointEdgeChunks) {
    ...
    this.macroCircle = new Circle("MACRO_" + name);
  }

  private void configureMacroCircle(long macroRadius, long macroCenter) {
  ...
  public long getRange() {
    ...
    configureMacroCircle(macroRadius, macroCenter);
    return macroCircle.getRange() * pointArea;
  }
  ...
  public long xzToLocation(long cx, long cz) {
    ...
    long macroLoc = macroCircle.xzToLocation(px, pz);
  ...
  public void locationToXZ(long loc, MutableRTPCoords output) {
    ...
    macroCircle.locationToXZ(macroLoc, output);
