 ...
 *
 * <p>Lives in the V26_2_R1 module so its compiled bytecode references Mojang
 ...
 */
public final class V26_2_R1FabricRTPChunk extends RTPChunk<ChunkAccess> {
    ...
    public V26_2_R1FabricRTPChunk(ChunkAccess chunk, ServerLevel level, UUID worldId) {
        super(chunk);
        this.level = level;
    ...
    public void keep(boolean keep) {
        ...
        RTPWorld<?> w = getWorld();
        if (w instanceof V26_2_R1FabricRTPWorld fw) {
