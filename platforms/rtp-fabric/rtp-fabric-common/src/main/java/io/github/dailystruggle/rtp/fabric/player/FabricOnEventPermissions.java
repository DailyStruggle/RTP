 ...
 * {@code OP_GRANTS} set is iterated in declaration order by the effective-permissions
 * resolver (callers should treat ordering as informational only).
 *
 * <p>See {@code rtp-fabric-ADR-011-effective-permissions-enumeration.md}.
 */
public final class FabricOnEventPermissions {
    ...
    private FabricOnEventPermissions() {}
}
