...
| `maps-api` | [`maps-api/docs/adr/`](../../maps-api/docs/adr/) | [maps-api-ADR-001](../../maps-api/docs/adr/maps-api-ADR-001-bootstrap.md) Module Bootstrap, Package Layout, and Palette Policy (Accepted) |
