...
| REQ-RTP-F-003 | Distributions (Flat/Normal) | DESIGN.md section 3 | `Circle_Normal`, `Square_Normal`; shared gaussian draw in `NormalMemoryShape.sample()` | `MemoryShapeTest`, `MemoryShapeSelectionParityTest` |
