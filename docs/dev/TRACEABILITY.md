...
| REQ-RTP-F-002 | Geometry (Circle/Square/Rect) | DESIGN.md section 3 | `Circle`, `Square`, `Rectangle`, `Ellipse`, `Polygon`; shared selection in `MemoryShape.rand()` (template: `adjustRange` / `sample` / `postProcess`) | `MemoryShapeTest`, `MemoryShapeSelectionParityTest` |
